...
@Injectable()
export class AccountsService extends PersistentCRUDService {
  constructor(
    ...
    super('accounts', http, authService, dbService, syncService, dataQueryService, eventsService, AppConfiguration);
  }

  createModel(data: any): AccountModel {
    return new AccountModel(this, data);
  }
}