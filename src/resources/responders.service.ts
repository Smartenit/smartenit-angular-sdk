...
@Injectable()
export class RespondersService extends PersistentCRUDService {
  constructor(
    ...
    super('responders', http, authService, dbService, syncService, dataQueryService, eventsService, AppConfiguration);
  }

  createModel(data: any): ResponderModel {
    return new ResponderModel(this, data);
  }
}